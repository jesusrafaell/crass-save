...
class PostgreWriteConnection {
  public static instance: PostgreWriteConnection;
  ...
  public static getInstance(): PostgreWriteConnection {
    if (!PostgreWriteConnection.instance) {
      PostgreWriteConnection.instance = new PostgreWriteConnection();
    }

    return PostgreWriteConnection.instance;
  }
...
export default PostgreWriteConnection;
